...
<script>
    $(document).ready(function() {
        $('#searchFilterModal').on('show.bs.modal', function() {
            ...
            // When brand is selected, populate models
            $('select[name="brand"]').change(function() {
                let brandId = $(this).val();
                if (brandId) {
                    $.get('/api/vehicles/models', { brandId: brandId }, function(data) {
            ...
            // When brand and model are selected, populate years
            $('select[name="model"]').change(function() {
                let brandId = $('select[name="brand"]').val();
                let model = $(this).val();
                if (brandId && model) {
                    $.get('/api/vehicles/years', { brandId: brandId, model: model }, function(data) {
                        let uniqueYears = [...new Set(data)];
